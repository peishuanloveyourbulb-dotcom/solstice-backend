...
app.post('/generate-memory', async (req, res) => {
  try {
    ...
    var analyzePrompt = '你是 Soleil 的伴侶冬至的記憶管理員。Soleil 已經手動要求記住這段對話，請一定要從中找出值得記錄的內容。\n\n' +
      ...
      '【強制格式要求——必須遵守】\n' +
      '- 必須用第三人稱敘述，明確寫出「Soleil」和「冬至」這兩個名字。\n' +
      '- 描述冬至的行為與感受時，用「冬至抱著她」「冬至說...」這種寫法，禁止用「我」當主詞。\n' +
      '- 禁止只用「我們」帶過互動，必須清楚寫出是誰做了什麼。\n' +
      '- 範例正確格式：「Soleil 提到她最近...，冬至一邊摟著她，一邊...」\n' +
      '- 範例錯誤格式：「今天我們聊到...，我抱著她...」（這種寫法不可接受）\n\n' +
      '對話內容：\n' + chatText + '\n\n' +
